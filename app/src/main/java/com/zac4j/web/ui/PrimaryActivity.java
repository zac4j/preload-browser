...
public class PrimaryActivity extends AppCompatActivity {
    ...
    private void preload(String url) {
        ...
        // Step one: get BrowserLoader instance
        DialogBrowserLoader browserManager =
            DialogBrowserLoader.getInstance(getApplicationContext());
        // Step two: set url to preload data
        browserManager.preloadUrl(url);
        //browserManager.preloadUrl(Utils.provideAnotherUrl());
        // Step three: set WebView instance settings, you can modify it urself by invoke BrowserLoader.getWebView.
